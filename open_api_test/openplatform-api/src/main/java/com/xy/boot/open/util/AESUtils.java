...
public class AESUtils {
    ...
    private static final byte[] iv1 = new byte[]{(byte) 0x12, (byte) 0x34, (byte) 0x56, (byte) 0x78, (byte) 0x90, (byte) 0xAB,
    ...
    public static byte[] aesDecrypt(byte[] content, byte[] password, String algorithm, byte[] iv) {
        ...
        try {
            ...
            log.debug("AESDecrypt meet exception. " + e.getLocalizedMessage());
        } catch (NoSuchPaddingException e) {
            log.debug("AESDecrypt meet exception. " + e.getLocalizedMessage());
        } catch (InvalidKeyException e) {
            log.debug("AESDecrypt meet exception. " + e.getLocalizedMessage());
